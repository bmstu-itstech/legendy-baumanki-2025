...
pub const PROMPT_SOLO_MODE_APPROVAL: StaticStr = "🧐 <b>Ты точно решил играть без команды?</b>\n\
    \n\
    Учти, что тогда не сможешь пройти все задания квеста, заработать баллы и участвовать в соревновательном зачете";

pub const SOLO_MODE_ENABLED: StaticStr = "👌 Хорошо! Ты остаёшься в соло режиме";

pub const PROMPT_TEAM_MODE_APPROVAL: StaticStr = "
    😊 <b>Ты хочешь перейти в командный режим?</b>
    \n\
    Тогда пришло время собрать команду от 5 до 8 человек. В этом режиме задания будут доступны полностью, и можно участвовать в соревновательном зачёте)";

pub const TEAM_MODE_ENABLED: StaticStr =
    "👌 Отлично! Мы зафиксировали, что ты хочешь играть в команде. Удачи!";
